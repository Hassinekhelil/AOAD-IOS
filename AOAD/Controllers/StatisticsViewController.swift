...
class StatisticsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if type == "menu" {
            ...
            if selectedController(indexPath: indexPath) is MapsViewController || selectedController(indexPath: indexPath) is ChartTypeViewController || selectedController(indexPath: indexPath) is StatisticsViewController {
    ...
    func selectedController(indexPath: IndexPath) -> UIViewController {
        ...
        switch names[indexPath.row] {
        case "الناتج المحلي الإجمالي", "Gross domestic product", "Produit Intérieur Brut", "التنظيمات المهنية للمنتجين الزراعين", "Professional organizations of agricultural producers", "Organisations professionnelles de producteurs agricoles", "قيمة الاستثمارات الكلية بالدولة", "The value of the total investments in the country", "La valeur des investissements totaux dans le pays", "معدلات سقوط الأمطار موزعة شهريا بالملم", "Rainfall rates are distributed monthly by millimeters", "Les taux de précipitations sont distribués mensuellement par millimètres":
